...
I looked at the drug distribution over time for each district. They look different. For example, TENDERLOIN (top) has been historically dominated by CRACK-related incidents (though this is changing in recent years). PARK (which is basically Haight-Ashbury) is mostly MARIJUANA-related incidents.
