...
["Ambient"](https://blog.langchain.dev/introducing-ambient-agents/) agents are becoming more common. They perform tasks autonomously and asynchronously "in the background", often without a chat interface.
