...
The conference also covered advances in agent training.
...
Also, the memory systems being piloted today are external to the model. [Nathan Lambert](https://x.com/natolambert) brought up the topic of continual learning, which has been mentioned [elsewhere](https://www.dwarkesh.com/p/timelines-june-2025) recently. It's possible that human feedback can be incorporated directly into the model in the future rather than using external memory systems.
