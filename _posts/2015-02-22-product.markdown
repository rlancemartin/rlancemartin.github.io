...
If product is a key lever that controls growth, then how to make product decisions to promote growth? Jeff Jordan [explains](http://jeff.a16z.com/2012/01/18/a-recipe-for-growth-adding-layers-to-the-cake/) two types of product innovation that combat slowing growth: optimize the existing product or develop new ones.
