...
Along with available city data, Uber has organized their own data into city- and neighborhood-specific features. For example, neighborhoods have [unique demand patterns](http://www.citylab.com/commute/2012/08/using-uber-ridership-data-compare-cities-and-neighborhoods/2890/). This means that each city and neighborhood can be understood as a potentially broad set of granular features.

These features provide a handle for organizing and comparing the diversity set of cities.
