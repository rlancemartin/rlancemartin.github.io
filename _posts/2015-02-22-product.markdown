...
[Alex Schultz](http://genius.com/Alex-schultz-lecture-6-growth-annotated) made a key point here. There is a distribution of users and some are about to churn off your app. With the retention curve in mind, it is important to study the marginal users and identify features that influence churn.
...
Identifying the features that classify the likelihood of churn appears to somewhat black magic. It's intuitive in some cases. In other situations, learning (classification) methods could probably be used. 

But, the best growth and product teams keenly understand this and are able to boil it doiwn. For Facebook, it was friend count. Zuck talks about getting people to 10 friends in 14 days. Josh Elman, product lead for growth at Twitter, explained that they focused on visits, with [7 times in a month](https://medium.com/@joshelman/the-only-metric-that-matters-ab24a585b5ea) the critical threshold.
