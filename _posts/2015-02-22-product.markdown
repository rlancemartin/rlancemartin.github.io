...
Paul Graham [said](http://www.paulgraham.com/growth.html) that "a startup is a company designed to grow fast". Growth distinguishes startups from the millions of local service businesses launched every year. If a startup adds a fixed number new users per week, the user count will scale linearly. Over time, the ratio of new users added per week approaches one. That isn’t very interesting. Startups want growth that is proportional to their current size. Over time, a fixed percentage of new users added per week leads to a non-linear explosion in total user count (red, below).
...
Exponential growth behaves in strange ways. Consider two companies, both growing exponentially with a two-fold difference in rate. After one year, the first startup passes the knee of its exponential trajectory. At this time, the difference in revenue between the two is more than 10-fold. Many of the iconic internet franchises have enjoyed this kind of run-away growth. 
...
This is often due to a network effect. For marketplace businesses like OpenTable or eBay, this is intuitive. As more buyers enter the system, more sellers are enter. This attracts more buyers. The resulting flywheel can lead to a monopoly business. For example, OpenTable has over [90 % market share](http://www.gourmetmarketing.net/rezbook-review-new-opentable-competitor/) in online restaurant reservations.
