...
Consider two companies growing with a two-fold difference in rate. After one year, the first startup has passed the knee of its exponential and the difference in revenue between the two is more than 10-fold. Many of the iconic startups have enjoyed this run-away growth, often due to a network effect. For marketplace businesses like OpenTable, this is intuitive. As more restaurants enter the system, more diners follow. This attracts more restaurants. This flywheel has lead to a monopoly business. OpenTable has over [90 % market share](http://www.gourmetmarketing.net/rezbook-review-new-opentable-competitor/) in online restaurant reservations.
