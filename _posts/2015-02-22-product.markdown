...
That's why companies like Uber, AirBnB, and others are so interesting. In the case of Uber, the full-stack digital grid is an unprecedented experimental machine. Product science on top of this can clearly improve existing services (such as POOL) that drive down cost for consumer and [have positive knock-on effects for cities](http://abovethecrowd.com/2015/01/30/ubers-new-bhag-uberpool/). 

Propduct science on top of this grid is also really interesting because it can guide development of new experiences: Uber's experimentation with on-demand [flu shots](http://blog.uber.com/health), [weddings](http://blog.uber.com/uberwedding), and [logistics](http://blog.uber.com/RUSH) point to the fact that it's possible ask questions on a scale that no one else can.
